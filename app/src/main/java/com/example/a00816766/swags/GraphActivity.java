...
public class GraphActivity extends Activity
    ...
    public void openSession(View view) {
        Intent propertiesIntent = new Intent(this, SessionActivity.class);
    ...
    private void getResultsFromApi() {
        if (!isGooglePlayServicesAvailable()) {
            ...
            mOutputText.setText("Weird Credential");
        }
    }
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            String spreadsheetId = "1-2wrTOumi3xyN1rmKkstrmuB5m7qDfz_9XNO-odaJCs";
            String range = "sheet1!E3:J23";
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            GraphActivity.REQUEST_AUTHORIZATION);
                } else {
